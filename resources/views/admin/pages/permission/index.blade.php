                    ...
                    <table class="table table-hover">
                        ...
                        <tbody class="table-border-bottom-0">
                            @forelse ($permissions as $permission)
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <button class="dropdown-item" tabindex="0"
                                                    aria-controls="DataTables_Table_0" type="button" data-bs-toggle="modal"
                                                    data-bs-target="#editPermissionModal{{ $permission->permission_slug }}"><i
                                ...
                                <div class="modal fade" id="editPermissionModal{{ $permission->permission_slug }}"
                                        ...
                                        <div class="modal-content p-3 p-md-5">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form
                                                    ...
                                                    id="editPermissionForm" class="row" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="col-12 mb-3" data-select2-id="114">
                                                        ...
                                                        <div class="position-relative" data-select2-id="113">
                                                            <select id="select2Basic" name="module_id"
                                                                ...
                                                                data-allow-clear="true" data-select2-id="select2Basic"
                                                                tabindex="-1" aria-hidden="true">
                                                    ...
                                                    <div class="col-12 mb-3">
                                                        ...
                                                        <input type="text" id="permission_name" name="permission_name"
                                                            value="{{ $permission->permission_name }}" class="form-control"
